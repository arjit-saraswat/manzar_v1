...
import FluidBackground from '@/components/festival/fluid-background';
import GradientText from '@/components/festival/glitch-text';
import CustomCursor from '@/components/festival/custom-cursor';
import ArtistCard from '@/components/festival/artist-card';
import { Artist } from '@/components/festival/types';
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-[#4fb7b3] selection:text-black cursor-auto md:cursor-none overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-8 py-6 mix-blend-difference">
        <div className="font-heading text-xl md:text-2xl font-bold tracking-tighter text-white cursor-default z-50">MANZAR</div>
        ...
        <div className="hidden md:flex gap-10 text-sm font-bold tracking-widest uppercase items-center">
          ...
          <Link
            href="/studio"
            className="text-[#a8fbd3] hover:text-white transition-colors cursor-pointer"
            data-hover="true"
          >
            Studio
          </Link>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            <Link
              href="/studio"
              className="text-4xl font-heading font-bold text-[#a8fbd3] hover:text-white transition-colors uppercase"
            >
              Studio
            </Link>
            <button
              ...
              <div key={key} className="flex whitespace-nowrap shrink-0">
                {[...Array(4)].map((_, i) => (
                  <span key={i} className="text-3xl md:text-7xl font-heading font-black px-8 flex items-center gap-4">
                    MANZAR 2025 <span className="text-black text-2xl md:text-4xl">●</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            <div className="lg:col-span-5 order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-8 md:mb-12 font-light leading-relaxed drop-shadow-md">
                Manzar isn't just a festival; it's a sensory expedition. We fuse cutting-edge audio technology with generative art to create a living, breathing ecosystem of sound.
              </p>
      ...
      <footer className="relative z-10 border-t border-white/10 py-12 md:py-16 bg-black/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div>
            <div className="font-heading text-3xl md:text-4xl font-bold tracking-tighter mb-4 text-white">MANZAR</div>
            <div className="flex gap-2 text-xs font-mono text-gray-400">
              <span>created by Manzar Studios</span>
            </div>
          </div>
